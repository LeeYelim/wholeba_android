...
public class NetworkManager {
	...
	public interface OnResultListener<T> {
		...
		//public void onFaliString(String failmessage);
	}
	...
	public void login(Context context, String user_id, String user_pass,
			String user_phone, String user_regid,
			final OnResultListener<LoginResult> listener) {
		...
		client.post(context, LOGIN_URL, params, new TextHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				Gson gson = new Gson();
				LoginResult results = gson.fromJson(responseString,
						LoginResult.class);
	...
	/*----------중복로그인 시도---------*/
	public static final String ACCEPT_LOGIN_URL = HTTPS_SERVER
			+ "/users/acceptlogin";

	public void acceptLogin(Context context, int user_no, String user_regid, String user_phone, 
			String user_regid_old, String user_phone_old,
			final OnResultListener<LoginResult> listener) {
		RequestParams params = new RequestParams();
		params.put("user_no", ""+user_no);
		params.put("user_regid", user_regid);
		params.put("user_phone", user_phone);
		params.put("user_regid_old", user_regid_old);
		params.put("user_phone_old", user_phone_old);
		
		client.post(context, ACCEPT_LOGIN_URL, params,
	...
	public void addjoin(Context context, String user_id, String user_pw,
			String user_phone, String user_regid, String user_regdate,
			final OnResultListener<JoinResult> listener) {
		...
		client.post(context, JOIN_URL, param, new TextHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers,
					String responseString) {
				Gson gson = new Gson();
				JoinResult results = gson.fromJson(responseString,
						JoinResult.class);
				listener.onSuccess(results);
			}
	...
	/*-----------가입정보 조회---------*/
	// 더미public static final String SEARCH_JOIN_INFO_URL = SERVER +
	// "/users/join/%s/%s/%s";
	/*
	 * public void searchJoinInfo(Context context, int join_code, String gender,
	 * int user_req, final OnResultListener<JoinResult> listener) {
	 * RequestParams param = new RequestParams(); param.put("join_code",
	 * join_code); param.put("gender", gender); param.put("user_req", user_req);
	 * String url = String.format(SEARCH_JOIN_INFO_URL, join_code, gender,
	 * user_req);
	 * 
	 * client.get(context, url, param, new TextHttpResponseHandler() {
	 * 
	 * @Override public void onSuccess(int statusCode, Header[] headers, String
	 * responseString) { Gson gson = new Gson(); JoinResult results =
	 * gson.fromJson(responseString, JoinResult.class);
	 * listener.onSuccess(results); }
	 * 
	 * @Override public void onFailure(int statusCode, Header[] headers, String
	 * responseString, Throwable throwable) { listener.onFail(statusCode); } });
	 * }
	 */
	...
	public void searchJoinInfo(Context context,
			final OnResultListener<JoinResult> listener) {

		client.get(context, SEARCH_JOIN_INFO_URL,
				new TextHttpResponseHandler() {
	...
	public void coupleAsk(Context context, String auth_phone,
			String user_gender, final OnResultListener<JoinResult> listener) {
		RequestParams params = new RequestParams();
		params.put("auth_phone", auth_phone);
		params.put("user_gender", user_gender);

		client.post(context, COUPLE_ASK_URL, params,
				new TextHttpResponseHandler() {
	...
	public void coupleAnswer(Context context,
			final OnResultListener<JoinResult> listener) {
	...
	public void addCommonInfo(Context context, String couple_birth,
			String user_birth, final OnResultListener<JoinResult> listener) {
		RequestParams params = new RequestParams();
		params.put("couple_birth", couple_birth);
		params.put("user_birth", user_birth);

		client.post(context, USERS_COMMON_URL, params,
				new TextHttpResponseHandler() {
	...
	public void addWomanInfo(Context context, WomanInfoParcelData data,
			final OnResultListener<JoinResult> listener) {
		RequestParams params = new RequestParams();
		...
		try {
			client.post(context, ADD_WOMAN_INFO_URL, new StringEntity(json),
	...
	public void getCoupleInfoList(Context context,
			final OnResultListener<CoupleInfoResult> listener) {
		...
		client.get(context, COUPLE_INFO_URL, new TextHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers,
					String responseString) {
				Gson gson = new Gson();
				CoupleInfoResponse results = gson.fromJson(responseString,
						CoupleInfoResponse.class);
	...
	public void getUserInfo(Context context,
		...
		client.get(context, USER_INFO_URL, new TextHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers,
					String responseString) {
				Gson gson = new Gson();
				UserInfoResponse results = gson.fromJson(responseString,
	...
	/*--------내기분 변경--------*/
	public static final String MY_CONDITION_URL = SERVER
			+ "/couple/mycondition";

	public void myCondition(Context context, int condition_no,
			final OnResultListener<UserInfoResult> listener) {

		RequestParams params = new RequestParams();
		params.put("condition_no", "" + condition_no);
		client.post(context, MY_CONDITION_URL, params,
				new TextHttpResponseHandler() {
					...
					public void onSuccess(int statusCode, Header[] headers,
						...
						// TODO Auto-generated method stub
						Gson gson = new Gson();
						UserInfoResponse results = gson.fromJson(
								responseString, UserInfoResponse.class);
						UserInfoResult list = results.result;
						listener.onSuccess(list);
					}
	...
	public void getDdayList(Context context,
			final OnResultListener<DdayResult> listener) {
		RequestParams params = new RequestParams();
	...
	public void addDday(Context context, String ddayname, String ddaydate,
			int ddayrepeat, final OnResultListener<DdayResponse> listener) {
		RequestParams params = new RequestParams();
		params.put("dday_repeat", "" + ddayrepeat);
		params.put("dday_name", ddayname);
		params.put("dday_date", ddaydate);

		client.post(context, DDAY_ADD_URL, params,
				new TextHttpResponseHandler() {
	...
	public void editDday(Context context, int ddayno, String ddayname,
			String ddaydate, int ddayrepeat,
			final OnResultListener<DdayResponse> listener) {
		RequestParams params = new RequestParams();
		params.put("dday_name", ddayname);
		params.put("dday_date", ddaydate);
	...
	public void deleteDday(Context context, int ddayno,
			final OnResultListener<DdayResponse> listener) {
	...
	public void getLoveList(Context context, int orderby, int year, int month,
			final OnResultListener<LoveSearchResult> listener) {
		/*
		 * RequestParams params = new RequestParams(); params.put("year",
		 * ""+year); params.put("month", ""+month); params.put("orderby",
		 * ""+orderby);
		 */
		String url = String.format(LOVE_SEARCH_URL, "" + year, "" + month, ""
				+ orderby);
		...
		client.get(context, url, null, new TextHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers,
					String responseString) {
				Gson gson = new Gson();
				LoveSearchResult results = gson.fromJson(responseString,
						LoveSearchResult.class);
				listener.onSuccess(results);
			}
	...
	public void addLove(Context context, int iscondom, String loves_date,
			int loves_ispopup, final OnResultListener<LoveSearchResult> listener) {
		RequestParams params = new RequestParams();
		params.put("loves_condom", "" + iscondom);
		params.put("loves_date", loves_date);
		params.put("loves_ispopup", "" + loves_ispopup);

		client.post(context, LOVE_ADD_URL, params,
				new TextHttpResponseHandler() {
					...
					public void onSuccess(int statusCode, Header[] headers,
						...
						// TODO Auto-generated method stub
						Gson gson = new Gson();
						LoveSearchResult results = gson.fromJson(
								responseString, LoveSearchResult.class);
						listener.onSuccess(results);
					}
	...
	public void addPopupLove(Context context, int loves_no,
			final OnResultListener<LoveSearchResult> listener) {
		RequestParams params = new RequestParams();
		params.put("loves_no", "" + loves_no);

		client.post(context, LOVE_ADD_POPUP_URL, params,
				new TextHttpResponseHandler() {
	...
	public void modifyLove(Context context, int loves_no, int is_condom,
			String date, final OnResultListener<LoveSearchResult> listener) {
		RequestParams params = new RequestParams();
		// params.put("loves_no", ""+relation_no);
		params.put("loves_condom", "" + is_condom);
		params.put("loves_date", date);
		String url = String.format(LOVE_EDIT_URL, "" + loves_no);
	...
	public void deleteLove(Context context, int loves_no,
			final OnResultListener<LoveSearchResult> listener) {
		// RequestParams params = new RequestParams();
		// params.put("loves_no", ""+relation_no);
		String url = String.format(LOVE_DELETE_URL, "" + loves_no);
	...
	public void getMissionIngList(Context context,
			final OnResultListener<MissionIngResult> listener) {
		...
		client.get(context, url, new TextHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				// TODO Auto-generated method stub
				Gson gson = new Gson();
				MissionIngResult results = gson.fromJson(responseString,
						MissionIngResult.class);
				listener.onSuccess(results);
			}
	...
	public void getMissionList(Context context, int year, int month,
			int orderby, final OnResultListener<MissionResult> listener) {
	...
	public void addMission(Context context, int theme_no,
			final OnResultListener<MissionResult> listener) {
		RequestParams params = new RequestParams();
		params.put("theme_no", "" + theme_no);

		client.post(context, MISSION_ADD_URL, params,
				new TextHttpResponseHandler() {
	...
	public static final String MISSION_CONFIRM_URL = SERVER
			+ "/missions/%s/confirm";

	public void confirmMission(Context context, int mlist_no,
			final OnResultListener<MissionResult> listener) {
		RequestParams params = new RequestParams();
	...
	public void searchMissionInfo(Context context, int mlist_no,
			final OnResultListener<MissionResult> listener) {
		RequestParams param = new RequestParams();
	...
	public static final String SUCCESS_MISSION_URL = SERVER
			+ "/missons/%s/success";

	public void successMisson(Context context, int mlist_no,
			final OnResultListener<MissionResult> listener) {
		RequestParams params = new RequestParams();
		params.put("mlist_no", mlist_no);
	...
	/*---------Mission 팝업 요청----------*/
	public static final String ASKPOPUP_MISSION_URL = SERVER
			+ "/missions/%s/success/popup";

	public void askpopup(Context context, int mlist_no,
			final OnResultListener<MissionResult> listener) {
	...
	/*
	 * public static final String ASKPOPUP_MISSION_URL = SERVER +
	 * "/missions/askpopup"; public void askpopup(Context context,int
	 * mlist_no,final OnResultListener<MissionResult> listener){ RequestParams
	 * params = new RequestParams(); params.put("mlist_no", mlist_no);
	 * 
	 * client.post(context, ASKPOPUP_MISSION_URL, params, new
	 * TextHttpResponseHandler() {
	 * 
	 * @Override public void onSuccess(int statusCode, Header[] headers, String
	 * responseString) { // TODO Auto-generated method stub Gson gson = new
	 * Gson(); MissionResult results = gson.fromJson(responseString,
	 * MissionResult.class); listener.onSuccess(results); }
	 * 
	 * @Override public void onFailure(int statusCode, Header[] headers, String
	 * responseString, Throwable throwable) { // TODO Auto-generated method stub
	 * listener.onFail(statusCode); } }); }
	 */

	public static final String MISSION_SUCCESS_POPUP = SERVER
			+ "/missions/%s/success";

	public void missionPopupSuccess(Context context, int mlist_no,
			String mlist_successdate,
			final OnResultListener<MissionResult> listener) {
		RequestParams params = new RequestParams();
	...
	public void getBuyInfo(Context context,
			final OnResultListener<BananaItemResponse> listener) {
		client.get(context, POSSIBLE_ITEM_LIST_URL,
				new TextHttpResponseHandler() {
					...
					public void onSuccess(int statusCode, Header[] headers,
							String responseString) {
						Gson gson = new Gson();
						BananaItemResponse results = gson.fromJson(
								responseString, BananaItemResponse.class);
						listener.onSuccess(results);
					}
	...
	public void getOwnItemInfo(Context context,
			final OnResultListener<BananaItemResponse> listener) {
	...
	public void useItem(Context context, String item_usedate, int item_no,
			int mlist_no, String mission_name,
			final OnResultListener<BananaItemResponse> listener) {
		RequestParams params = new RequestParams();
		params.put("item_usedate", item_usedate);
	...
	/*-----------설정창---------*/
	public static final String GET_WOMAN_INFO_URL = SERVER
			+ "/setting/herself/%s";

	public void getWomanInfoList(Context context, String user_gender,
			final OnResultListener<WomanInfoResponse> listener) {
		...
		client.get(context, url, new TextHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				// TODO Auto-generated method stub
				Gson gson = new Gson();
				WomanInfoResponse results = gson.fromJson(responseString,
						WomanInfoResponse.class);
				listener.onSuccess(results);
			}
	...
	public void setPublic(Context context, int user_public,
			final OnResultListener<WomanInfoResponse> listener) {
		RequestParams params = new RequestParams();
		params.add("user_public", "" + user_public);

		client.post(context, SET_PUBLIC_URL, params,
				new TextHttpResponseHandler() {
					...
					public void onSuccess(int statusCode, Header[] headers,
						...
						// TODO Auto-generated method stub
						Gson gson = new Gson();
						WomanInfoResponse results = gson.fromJson(
								responseString, WomanInfoResponse.class);
						listener.onSuccess(results);
					}
	...
	public void editPeriod(Context context, List<PeriodItems> items,
			final OnResultListener<WomanInfoResponse> listener) { 
		PeriodItems[] periods = new PeriodItems[items.size()];
		//List<PeriodItems> pItems = new ArrayList<PeriodItems>();
		//pItems.addAll(items);
...
//			periods[i] = items.get(i);
//		} 
		Gson gson = new Gson();
		String json = gson.toJson(items);
		
		params.put("periods", json);
		
		client.post(context, EDIT_PERIOD_URL, params,
				new TextHttpResponseHandler() {
	...
	public void getNotic(Context context,
		...
		client.get(context, NOTICE_URL, new TextHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers,
					String responseString) {
				Gson gson = new Gson();
				NoticeResponse results = gson.fromJson(responseString,
	...
	public void logout(Context context,
			final OnResultListener<LogoutResponse> listener) {
		...
		client.post(LOGOUT_URL, new TextHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers,
					String responseString) {
				Gson gson = new Gson();
				LogoutResponse results = gson.fromJson(responseString,
	...
	public void withDraw(Context context,
			final OnResultListener<WithDrawReponse> listener) {
		...
		client.post(WITHDRAW_URL, new TextHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers,
					String responseString) {
				Gson gson = new Gson();
				WithDrawReponse results = gson.fromJson(responseString,
						WithDrawReponse.class);
				listener.onSuccess(results);
			}
